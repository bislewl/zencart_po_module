...
define('BOX_TOOLS_SET_SUBCONTRACTORS_MANUF', 'PO Assign to manufacturers');
define('BOX_CONFIGURATION_PURCHASE_ORDERS', 'PO Configuration');
define('BOX_PDFPACK','pdfpack');
define('PO_MODULE','PO Module Settings');
